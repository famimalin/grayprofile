...
class ReactImageLightbox extends Component {
    ...
    componentDidMount() {
        ...
        Object.keys(this.listeners).forEach((type) => {
            this.windowContext.addEventListener(type, this.listeners[type], { passive: false });
        });
    ...
    changeZoom(zoomLevel, clientX, clientY) {
        ...
        const pointerX =
            typeof clientX !== "undefined" ? clientX - boxRect.left : boxRect.width / 2;
        const pointerY =
            typeof clientY !== "undefined" ? clientY - boxRect.top : boxRect.height / 2;
    ...
    render() {
        ...
        return (
            <Modal
                ...
                appElement={
                    typeof global.window !== "undefined" ? global.window.document.body : undefined
                }
                {...reactModalProps}
            >
